...
def run_tests():
    ...
    print(f"[OK] submission.csv has exactly 100 rows and correct columns: {expected_cols}")
    ...
    print("[OK] Ranks are sequentially numbered 1 to 100.")
    ...
    print("[OK] Scores are monotonically non-increasing.")
    ...
    print("[OK] Equal scores are correctly sorted by candidate_id in ascending order.")
    ...
    print(f"[OK] Zero honeypots found in top 100 (Honeypot rate: 0.0%).")
    ...
    print("[OK] No overqualified candidates (YoE > 12) in top 10.")
    ...
    print("\n[OK] ALL TESTS PASSED SUCCESSFULLY! Submission is 100% compliant.")
    print("=" * 60)
